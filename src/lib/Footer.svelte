...
<footer class="bg-[#352339]">
	<div class="container mx-auto p-6">
			...
			<div class="-mx-6 w-full lg:w-2/5">
				<div class="px-6">
					...
					<div class="-mx-2 mt-6 flex">
						<a
							href="https://www.youtube.com/@savyasachidas"
							target="_blank"
							class="mx-2 text-purple-200 transition-colors duration-300"
							aria-label="Reddit"
						>
							<svg
								role="img"
						...
						<a
							href="https://www.instagram.com/savyasachidasa/"
							target="_blank"
							class="mx-2 text-purple-200 transition-colors duration-300"
						...
						<a
							href="https://www.facebook.com/savyasachidasa"
							target="_blank"
							class="mx-2 text-purple-200 transition-colors duration-300"
							aria-label="Github"
						>
		...
		<div>
			<p class="text-center text-pink-200">© ISKCON Bhopal 2024 - All rights reserved</p>
		</div>
	</div>
</footer>
